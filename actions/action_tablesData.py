...
class AppTablesData(QDialog):
    ...
    def refreshAllTables(self):
        ...
        self.refreshTable(self.ui.label_vue_epreuves, self.ui.vue_epreuves,"SELECT numEp, nomEp, nombreInscrit, formeEp, categorieEp, nbSportifsEp, dateEp, nomDi FROM LesEpreuvesView")
